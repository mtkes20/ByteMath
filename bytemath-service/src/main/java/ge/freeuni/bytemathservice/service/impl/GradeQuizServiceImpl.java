...
public class GradeQuizServiceImpl implements GradeQuizService {
    ...
    @Override
    public GradedQuestion createUnansweredGradedQuestion(Question question, String language) {
    ...
    @Override
    public String getCorrectAnswerText(Question question, String language) {
    ...
    @Override
    public GradedQuestion gradeQuestion(SubmittedAnswer submittedAnswer, Question question, String language) {
