...
public class UserQuizSubmissionServiceImpl implements UserQuizSubmissionService {
    ...
    @Override
    public GradedQuestion convertToGradedQuestion(Question question, UserQuizSubmission submission, String language) {
    ...
    @Override
    public SubmittedAnswerEntity convertToSubmittedAnswerEntity(SubmittedAnswer answer) {
