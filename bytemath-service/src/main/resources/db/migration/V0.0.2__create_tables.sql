...
(
    ...
    INPUT_FORMAT_ENG    VARCHAR(255),
    INPUT_FORMAT_GEO    VARCHAR(255),
    OUTPUT_FORMAT_ENG   VARCHAR(255),
    OUTPUT_FORMAT_GEO   VARCHAR(255),
    EXAMPLE_ENG         VARCHAR(255),
    EXAMPLE_GEO         VARCHAR(255),
    NOTE_ENG            VARCHAR(255),
    NOTE_GEO            VARCHAR(255),
    PYTHON_TEMPLATE_ENG VARCHAR(1000),
    PYTHON_TEMPLATE_GEO VARCHAR(1000),
    JAVA_TEMPLATE_ENG   VARCHAR(1000),
    JAVA_TEMPLATE_GEO   VARCHAR(1000),
    PYTHON              INTEGER,
    JAVA                INTEGER,
